---
title: The Standard Work Directory
...
<Task title="Navigate to and explore your MESA installation" number={1} tutorialNumber={tutorialNumber}>
...
<Answer>
    ...
    ```
    <Aside type='caution'>
  If you get an error that `$MESA_DIR` is not set, you need to set it up. Go back to the [prerequisites and setup tutorial](../prerequisites-and-setup) and ensure you've correctly installed MESA and set the appropriate environment variables, notably `MESA_DIR`, `MESASDK_ROOT`, and `OMP_NUM_THREADS`.
</Aside>
</Answer>
...
<LearningObjective statement="vaguely understand the contents of `$MESA_DIR`" number={1} tutorialNumber={tutorialNumber} />


## Structure of a MESA Module
Let's take a deeper dive into the `star` module.

<Task title="Explore the `star` module" number={2} tutorialNumber={tutorialNumber}>
...
<LearningObjective statement="vaguely understand the structure of the MESA star module and its contents" number={2} tutorialNumber={tutorialNumber} />
...
<Task title="Create a standard MESA work directory" number={3} tutorialNumber={tutorialNumber}>
...
<LearningObjective statement="create a MESA work directory from the standard work directory" number={3} tutorialNumber={tutorialNumber} />
...
<Task title="Run your first MESA simulation" number={4} tutorialNumber={tutorialNumber}>
...
Great! You've run your first MESA simulation! The next steps will be to investiage the outputs that this simulation produces as well as how we can change the parameters of the simulation. These are the topics of the next tutorial.

<LearningObjective statement="compile and run a MESA simulation" number={4} tutorialNumber={tutorialNumber} />
