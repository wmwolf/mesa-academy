...
<Task title="Learn the Fundamentals" number={1} guideNumber={guideNumber}>
...
<Task title="Download and Install MESA" number={2} guideNumber={guideNumber}>
  Follow the [MESA Documentation](https://docs.mesastar.org/en/latest/) to download and install MESA. Make sure to follow the instructions for your operating system, and install any dependencies that are required.
</Task>
<Aside>
    While I aim for most MESA-related content in these guies to be self-contained, the MESA documentation is a great resource for a lot of common tasks and questions. If you get stuck, I recommend checking the [MESA Documentation](https://docs.mesastar.org/en/latest/) first. In the case of installation, the documentation is very well written, so you should be able to follow it without too much trouble.
</Aside>
